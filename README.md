...
After moving directory that contains configuration and functional units implementation files, it is needed to rerun `generate_fu` script, to update relative import paths.
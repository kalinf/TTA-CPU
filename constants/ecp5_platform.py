# modified code from https://github.com/DaveBerkeley/amaranth-boards/blob/colorlight_i9/amaranth_boards/colorlight_i9_r7_2.py
...
class Colorlight_i9_R72Platform(LatticeECP5Platform):
    ...
    resources = [
        ...
        *LEDResources(pins="L2", invert=True, attrs=Attrs(IO_TYPE="LVCMOS33", DRIVE="4")),
        ...
        Resource(
            ...
            Subsignal("miso", Pins("V2", dir="i")),
            Subsignal("mosi", Pins("W2", dir="o")),
        ...
        SDRAMResource(
            ...
            ras_n="B10",
            ba="B11 C8",
            a="B13 C14 A16 A17 B16 B15 A14 A13 A12 A11 B12",
        ...
        # rosources to prevent deleting design by syntezer
        Resource(
            "result",
            0,
            Pins("P17 R18 C18 L2 M17 R17 T18 K18 J20 L18 M18 N17 G20 K20 L20 N18", dir="o"),
            Attrs(IO_TYPE="LVCMOS33"),
        ),
        Resource(
            "write_port",
            0,
            Subsignal("en", Pins("D20", dir="i")),
            Subsignal("addr", Pins("F20 B19 B20 A19 B18 A18 C17", dir="i")),
            Subsignal("data", Pins("R3 M4 L5 J16 N4 L4 P16 J18 R1 U1 W1 M1 T1 Y2 V1 N2", dir="i")),
            Attrs(IO_TYPE="LVCMOS33"),
        ),
    ]

    # Adapter Board : (p5, H18 not working on author's board)
    connectors = [
        Connector(
            "p",
            2,
            "- - - - K18  L2 T18 C18 R17 R18 M17 P17 U18 T17 - - P18 U17 - - - - N18 N17 L20 M18 K20 L18 J20 G20",
        ),
        Connector(
            "p",
            3,
            "- - - - D20 F20 B19 B20 A19 B18 A18 C17  D3  C4 - -  C3  B4 - - - -  A3  E3  B1  C2  D2  C1  E2  D1",
        ),
        Connector(
            "p",
            4,
            "- - - -  E1  F2  E4  F1  F3  G3  H3  H4  H5  J4 - -  J5  K3 - - - -  A2  K5  K4  B3  B2 E19   -   -",
        ),
        Connector(
            "p",
            5,
            "- - - -  F4  E5  E6  F5 D16  G5 D17 D18 E17 E16 - - F16 F17 - - - - E18 G16 F18 H16 G18 H17 H18 J17",
        ),
        Connector(
            "p",
            6,
            "- - - - J18 J16 P16  L5  L4  M4  N4  R3  T3  M3 - -  T2  N3 - - - -  N2  M1  V1  W1  Y2  U1  T1  R1",
        ),
        # P2
